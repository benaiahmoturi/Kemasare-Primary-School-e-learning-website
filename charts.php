      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="utilities-color.php">Students</a>
            <a class="collapse-item" href="utilities-border.php">Teachers</a>
            <a class="collapse-item" href="utilities-animation.php">People</a>
