          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    foreach ( $rows as $row ) {
                        ...
                        echo("</td><td>");
                        echo($row['current_marks']);
                        echo("</td><td>");
                        echo($row['previous_marks']);
                        echo("</td><td>");
                        echo($row['difference']);
                        echo("</td><td>");
                        ...
                        echo('name="student_id" value="'.$row['student_id'].'">'."\n");
                ...
                <p><b>Add Marks to the Table</b></p>
                <form method="post">
                Student Name:
                <input type="text" name="student_name" required placeholder="Student Name">
                Current Marks:
                <input type="integer" name="current_marks" required placeholder="Current Marks">
                Previous Marks:
                <input type="number" name="previous_marks" required placeholder="Previous Marks">
                Difference:
                <input type="number" name="difference" required placeholder="Difference"><br><br>
              <p>  Teacher's Comment:
                <input type="text" name="teacher_comment" placeholder="Maximum of two words"></p>
